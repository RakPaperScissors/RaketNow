...
const predefinedSkills = [
  { skill_Id: 1, skillName: 'Carpentry', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 2, skillName: 'Gardening', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 3, skillName: 'House Cleaning', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 4, skillName: 'Plumbing', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 5, skillName: 'Electrician', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 6, skillName: 'Handyman Services', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 7, skillName: 'Aircon Cleaning & Repair', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 8, skillName: 'Appliance Repair', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 9, skillName: 'Roof Repair', category: 'Home Repairs & Maintenance Services' },
  { skill_Id: 10, skillName: 'Pest Control', category: 'Home Repairs & Maintenance Services' },
