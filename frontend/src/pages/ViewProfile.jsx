...
import { Mail, User, Hammer, Pencil, X, ArrowLeft } from "lucide-react";
    ...
    <div className="flex">
      ...
      <main className={`flex-1 relative min-h-screen bg-[#F9FAFB] overflow-y-auto transition-all duration-200 ${
        ...
        <div className="px-10 py-16">
          ...
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-[#0c2c57] hover:text-[#ff7c2b] transition-colors duration-200 mb-4"
          >
            <ArrowLeft className="w-6 h-6" />
          </button>

          <h1 className="text-2xl font-bold text-[#0c2c57] mb-6 px-8">
